          ...
          <form onSubmit={handleCrearUsuario} className="grid sm:grid-cols-7 gap-3 items-end mb-4">
            ...
            <div>
              <label className="label">
                Facultad{nuevoUsuario.rol === "secretaria_academica" ? " (no aplica)" : ""}
              </label>
              <input
                className="input"
                ...
                placeholder={
                  nuevoUsuario.rol === "secretaria_academica" ? "No aplica" : "Como aparece en el Excel"
                }
                disabled={nuevoUsuario.rol === "secretaria_academica"}
                required={nuevoUsuario.rol !== "secretaria_academica"}
              />
            </div>
            <div>
              ...
              >
                ...
                <option value="secretaria_academica">
                  Secretaría académica (sedes, salones, grupos, estudiantes)
                </option>
              </select>
            </div>
            <div>
                  ...
                  <tr key={u.id} className="border-b last:border-0">
                    ...
                    <td className="py-1.5 pr-3">
                      {u.rol === "admin"
                        ...
                        : u.rol === "coordinador"
                        ? "Coordinador"
                        : u.rol === "secretaria_academica"
                        ? "Secretaría académica"
                        : "Decano"}
                    </td>
                    <td className="py-1.5 pr-3">{u.facultad || "—"}</td>
                    <td className="py-1.5 pr-3">
                      {u.rol === "decano" || u.rol === "coordinador" || u.rol === "secretaria_academica" ? (
                        <input
                          type="email"
